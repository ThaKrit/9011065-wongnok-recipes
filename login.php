        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                ...
                <form class="form-inline my-2 my-lg-0">
                    <a class="btn btn-success btn-sm ml-3" href="register.php">Register</a>
                    <a class="btn btn-success btn-sm ml-3" href="#">Login</a>
                </form>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="col-md-8 mx-auto">
            ...
            <div class="card rounded-0">
                ...
                <div class="card-body">
                    <form class="form" role="form" autocomplete="off" id="formLogin" method="post" action="controls/login.php">
                        ...
                        <div class="form-group">
                            ...
                            <input name="txtPassword" id="txtPassword" type="password" class="form-control form-control-lg rounded-0" required="" autocomplete="new-password">
                        </div>
                        <button type="submit" name="submit" value="save" class="btn btn-success btn-lg float-right">Login</button>
                    </form>
                </div>
            </div>
        </div>
